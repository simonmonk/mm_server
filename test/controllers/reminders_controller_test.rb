...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { prospect_id: @reminder.prospect_id, reminder_date: @reminder.reminder_date, user_id: @reminder.user_id } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { prospect_id: @reminder.prospect_id, reminder_date: @reminder.reminder_date, user_id: @reminder.user_id } }
